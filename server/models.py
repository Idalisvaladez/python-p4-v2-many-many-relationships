...
class Employee(db.Model):
    ...
    #Relationship mapping the employee to relates assignments
    assignments = db.relationship(
        'Assignment', back_populates = 'employee', cascade = 'all, delete-orphan'
    )

    #Association proxy to get proects for this employee through assignemnts
    projects = association_proxy('assignments', 'project',
                                 creator = lambda project_object : Assignment(project = project_object))
...
class Meeting(db.Model):
    ...
    #Relationship mapping meeting to related employee
...
class Project(db.Model):
    ...
    employees = association_proxy('assignments', 'employee',
                                  creator = lambda employee_object: Assignment(employee = employee_object))
